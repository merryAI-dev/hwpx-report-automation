...
import { runBatchPipeline, runPlaceholderBatchPipeline, inspectTemplate, detectPlaceholders, DEFAULT_COLUMN_MAPPING, type BatchMode, type ColumnMapping, type PlaceholderMapping } from "@/lib/batch/batch-pipeline";
...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    return handleApiError(err, "batch-generate/inspect");
  }
}
...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    return handleApiError(err, "batch-generate");
  }
}
