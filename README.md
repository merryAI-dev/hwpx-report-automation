...
## PostgreSQL 설정 (Fly.io 배포)

1. Fly.io Postgres 클러스터 생성:
   ```bash
   fly postgres create --name hwpx-db --region nrt
   fly postgres attach hwpx-db --app hwpx-report
   ```

2. 또는 외부 PostgreSQL URL 설정:
   ```bash
